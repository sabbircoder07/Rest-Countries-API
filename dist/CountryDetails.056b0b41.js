...
})({"NaPTC":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "75843e97056b0b41";
"use strict";
...
},{}],"11FSW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _modelJs = require("./model.js");
var _countryDetailsViewJs = require("./views/countryDetailsView.js");
var _countryDetailsViewJsDefault = parcelHelpers.interopDefault(_countryDetailsViewJs);
...
const controlCountryDetails = async function() {
    try {
        const CountryName = (0, _countryDetailsViewJsDefault.default).getCountyName();
        if (!CountryName) return;
        (0, _countryDetailsViewJsDefault.default).renderSpinner();
        await _modelJs.loadCountryDetails(CountryName);
        setTimeout(function() {
            const data = _modelJs.state.countryDetails;
            (0, _countryDetailsViewJsDefault.default).render(data);
        }, _configJs.SHOW_COUNTRIES_SEC * 1000);
    //renders countries
    } catch (err) {
        // Alert the user of any errors
        (0, _countryDetailsViewJsDefault.default).renderError(err);
    }
};
...
const init = function() {
    ...
    (0, _countryDetailsViewJsDefault.default).addHandlerRender(controlCountryDetails);
};
init();

},{"./model.js":"Py0LO","./views/countryDetailsView.js":"hHoY6","./views/modeSwitcherView.js":"eYTJm","./config.js":"4Wc5b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Py0LO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./config.js":"4Wc5b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hHoY6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CountryDetailsView", ()=>CountryDetailsView);
class CountryDetailsView {
    ...
    <img class="country-details__img" alt="${this.#data.name}" src="${this.#data.flag}" />
    <div class="country-details__data">
      <h1 class="heading-primary-large country-details__name">${this.#data.name}</h1>
      ...
      <p class="country-details__row"><span>Top Level Domain:</span>${!this.#data.topLevelDomain ? "Not Found" : this.#data.topLevelDomain} </p>
      ...
      ${typeof this.#data.currencies === "object" ? this.#data.currencies[Object.keys(this.#data.currencies)[0]].name : ""}
      </p>
      ...
      <p class="country-details__row"><span>Sub Region: </span>${this.#data.subregion}
        </p>
      <p class="country-details__row"><span>Capital: </span>${this.#data.capital}</p>
      </div>
      <div class="country-details__border-info">
        ...
        ${this.#data.borders ? this.#data.borders.map((border)=>`<a href="countryDetails.html?name=${border}" class="country-details__border" >${border}</a>`).join("") : "Not Found"}
        </div>
      </div>
    </div>  
  </article>`;
...
exports.default = new CountryDetailsView();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["NaPTC","11FSW"], "11FSW", "parcelRequire94c2")

//# sourceMappingURL=CountryDetails.056b0b41.js.map
